...
export const MachineCard: React.FC<MachineCardProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* ========================================================= */}
      {/* CASE 1: READY STATUS — ULTRA COMPACT SINGLE ROW LAYOUT   */}
      ...
      {currentStatus === 'READY' ? (
        <div className="flex items-center justify-between gap-2.5 sm:gap-4 flex-wrap sm:flex-nowrap">
          ...
          <div className="flex items-center gap-2.5 sm:gap-3.5 min-w-0 flex-1">
            <span className="w-10 h-10 sm:w-11 sm:h-11 lg:w-12 lg:h-12 rounded-xl bg-slate-900/80 border border-slate-700/60 p-1 sm:p-1.5 flex items-center justify-center shrink-0 shadow-md">
              <AssetIcon
          ...
          <div className="flex items-center gap-2 sm:gap-3 shrink-0">
            {/* ● READY */}
            <div className="flex items-center gap-1.5 px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-full bg-slate-800/80 border border-slate-700 text-slate-300 font-mono text-[10px] sm:text-xs font-black tracking-wider uppercase whitespace-nowrap shadow-xs">
            ...
            <button
              ...
              className="w-auto px-3.5 sm:px-5 py-2 rounded-xl bg-gradient-to-r from-amber-500 via-amber-400 to-amber-500 hover:from-amber-400 hover:to-amber-300 active:scale-95 text-slate-950 font-chakra font-black text-xs uppercase tracking-wider flex items-center justify-center gap-1.5 sm:gap-2 shadow-md shadow-amber-500/25 transition-all cursor-pointer ring-1 ring-amber-300/40 whitespace-nowrap min-h-[38px]"
            >
